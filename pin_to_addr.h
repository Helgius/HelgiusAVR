...
extern void set_DDR(uint8_t pin_hw_number, io_enum mode);
extern void set_PORT(uint8_t pin_hw_number, port_state_enum mode);
extern uint8_t get_PIN(uint8_t pin_hw_number);
